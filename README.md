...
# Сдаем отчетность
 ...
 - Редактировать:
   ...
   - Ряд 06 (Обсяг доходу за звитный период що оподатковуется за ставкою 5%) - сколько в сумме от начало года до этого квадрата, учитывая этот квартал
